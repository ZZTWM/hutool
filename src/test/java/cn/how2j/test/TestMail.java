...
public class TestMail {
    ...
    public void prepareMailAccount() {
        ...
        account.setFrom("15152806231@163.com"); //假邮箱，请自己申请真实邮箱
        account.setUser("twm183465"); //假邮箱，请自己申请真实邮箱
        account.setPass("twm183465"); //假密码，请自己申请真实邮箱
    }
    ...
    public void test1(){
        //因为账号密码不对，所以不能正确发送
        MailUtil.send(account,"twm183465", "hutool 测试邮件" + DateUtil.now(), "测试内容", false);
    }
    @Test
    @Comment("发送html邮件")
    public void test2(){
        //因为账号密码不对，所以不能正确发送
        MailUtil.send(account,"15152806231@163.com", "hutool 测试邮件" + DateUtil.now(), "<p>测试内容</p>", true);
    }
    @Test
    @Comment("发送带附件的邮件")
    public void test3(){
        ...
        //因为账号密码不对，所以不能正确发送
        MailUtil.send(account,"15152806231@163.com", "hutool 测试邮件" + DateUtil.now(), "<p>测试内容</p>", true, FileUtil.file("d:/test.txt"));
    }
